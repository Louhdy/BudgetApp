export const getInstanMessagePrice = (amountMessages) => {
  ...
  if ((amountMessages <= 25000) && (amountMessages > 10000)) return amountMessages*0.050;
  if ((amountMessages <= 50000) && (amountMessages > 25000)) return amountMessages*0.047;
  if ((amountMessages <= 100000) && (amountMessages > 50000)) return amountMessages*0.045;
  if ((amountMessages <= 250000) && (amountMessages > 100000)) return amountMessages*0.042;
  if ((amountMessages <= 500000) && (amountMessages > 250000)) return amountMessages*0.040;
